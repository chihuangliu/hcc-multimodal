...
| Task | `6a1a1bdf` cond 1 (10/10) | `6a1a1bdf` cond 2 (10/all) | `3e598f36` cond 3 (all/all) | `dc7e1d10` cond 4 (all/all, +5 ep) | `a64b245f` cond 5 (λ=0, 10 ep) |
|------|--------------------------|---------------------------|----------------------------|-------------------------------------|----------------------------------|
| Radiomics | 0.569 ± 0.133 | 0.569 ± 0.133 | 0.569 ± 0.133 | 0.569 ± 0.133 | 0.569 ± 0.133 |
| Embeddings | 0.798 ± 0.081 | 0.672 ± 0.090 | 0.911 ± 0.064 | **1.000 ± 0.000** | 0.739 ± 0.129 |
| Concat | 0.489 ± 0.096 | 0.545 ± 0.139 | 0.838 ± 0.163 | **1.000 ± 0.000** | 0.606 ± 0.203 |
| Ensemble | 0.696 ± 0.078 | 0.599 ± 0.065 | 0.807 ± 0.122 | 0.942 ± 0.082 | 0.623 ± 0.185 |
...
| Parameter | `6a1a1bdf` (0525) | `3e598f36` | `dc7e1d10` | `a64b245f` |
|-----------|-------------------|------------|------------|------------|
| Backbone | ViT-B/32 (unfrozen) | ViT-B/32 (frozen) | ViT-B/32 (frozen) | ViT-B/32 (frozen) |
| Base model | — | — | `3e598f36` | — |
| Embed dim | 128 | 128 | 128 | 128 |
| Gene hidden dim | 256 | 256 | 256 | 256 |
| Temperature τ | 0.07 | 0.07 | 0.07 | 0.07 |
| λ (reg weight) | 0.1 | 0.1 | 0.1 | **0.0** |
| reg_mode | per_modality | per_modality | per_modality | per_modality |
| Gene set | all | all | all | all |
| n_per_axis (train) | 10 | null (all) | null (all) | null (all) |
| Axes | sagittal (0) | sagittal (0) | sagittal (0) | sagittal (0) |
| MRI type | raw | raw | raw | raw |
| Epochs | 50 | 5 | 5 (+5 continued) | **10** |
| Batch size | 32 | 32 | 32 | 32 |
| Optimiser | AdamW (lr=1e-4, wd=1e-4) | AdamW (lr=1e-4, wd=1e-4) | AdamW (lr=1e-4, wd=1e-4) | AdamW (lr=1e-4, wd=1e-4) |
| LR schedule | Cosine (T_max=50) | Cosine (T_max=5) | Cosine (T_max=5) | Cosine (T_max=10) |
| Seed | 42 | 42 | 42 | 42 |
| Train loss (final epoch) | 1.330 | 0.238 | -0.140 | 1.240 |
| Val loss (best) | 1.327 | 0.259 | -0.085 | 1.316 |
